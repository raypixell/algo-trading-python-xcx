...
class Nifty:
    ...
    def __init__(self,socketio,selectedInterval):
        ...
        self.DOWNLOAD_ORDER_REPORT_FILE_NAME = "nifty_order_report_" + '%02d-%02d-%02d.txt' % (now.day,now.month,now.year)
    ...
    def startNiftyAlgo(self,timeInterval):
        ...
        try:
            ...
            if not self.TERMINATE_NIFTY:
                ...
                print('MAIN TRADING TOKEN : {}'.format(self.tokens[256265]))

                # Print log message about script started
                # Log String
                
                logString = 'SYMBOL : {}'.format(self.tokens[256265])
                self.sendLogReport(logString)
    ...
    def sendLogReport(self,logString):
        ...
        print(logString)
        self.socketio.emit('log_report_nifty',logData)
