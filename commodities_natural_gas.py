...
class NaturalGasCommodities:
    ...
    TERMINATE_NATURAL_GAS = None

    def __init__(self,socketio,selectedInterval):

        self.socketio = socketio
        self.TERMINATE_NATURAL_GAS = None
        ...
        self.DOWNLOAD_LOG_FILE_NAME = "natural_gas_" + '%02d-%02d-%02d.txt' % (now.day,now.month,now.year)
    ...
    def loginKite(self):
        ...
        self.logMessage = 'Natural Gas Script Started...'
    ...
    def stopThread(self):
        ...
        self.TERMINATE_NATURAL_GAS = True

    def startCommoditiesAlgo(self,timeInterval):

        self.TERMINATE_NATURAL_GAS = False
        
        try:
            while not self.TERMINATE_NATURAL_GAS:
                now = datetime.now()
                now = now.astimezone(self.tz)
    ...
    def sendLogReport(self,logString):
        ...
        logData = {"logReport" : logString,"selected_commodities":3}
